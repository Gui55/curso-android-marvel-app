...
class DetailViewModel @Inject constructor(
    private val getCharactersCategoriesUseCase: GetCharactersCategoriesUseCase
): ViewModel(){

    private val _uiState = MutableLiveData<UiState>()
    val uiState: LiveData<UiState> get() = _uiState
    fun getCharactersCategories(characterId: Int) = viewModelScope.launch {
        getCharactersCategoriesUseCase(GetCharactersCategoriesUseCase.GetCharacterCategoriesParams(characterId))
            .watchStatus()
    }

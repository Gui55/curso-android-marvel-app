...
class DetailViewModelTest{
    ...
    @Mock
    private lateinit var getCharactersCategoriesUseCase: GetCharactersCategoriesUseCase
    ...
    = runTest {
        ...
        detailViewModel.run {
            ...
            favorite.update(DetailViewArg(character.id, character.name, character.imageUrl))
        }
        // Assert
